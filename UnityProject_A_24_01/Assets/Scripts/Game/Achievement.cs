...
public class Achievement
{
    ...
    //생성자 함수 New 통해서 생성될때 관련 파라미터 값을 넣어주면 생서시 초기화 시켜준다)
    public Achievement(string name,string description, int goal)
    {
        ...
        this.goal = goal;               //완료 값을 인수로 받아온다.
    }

    public void AddProgress(int amount)  //횟수를 받아서 완료 값 체크 
    {
    ...
    protected virtual void OnAchievementUnlocked()  //보호 수준과 가상함수(Virtual) 처리를 해서 상속 시 함수를 개신 할 수 있게 선언
    {
